...
import discordhandler.database.Mongo;
import discordhandler.handlers.AntiCrash;
import discordhandler.handlers.CommandHandler;
import discordhandler.handlers.EventHandler;
import discordhandler.handlers.Logger;
import discordhandler.handlers.PrefixHandler;
...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        StartupData total = new StartupData(
                slashData.totalSlash,
                prefixData.totalPrefix,
