...
public class GuildDeleteHandler extends ListenerAdapter {
    private final java.util.function.Supplier<Integer> remainingServers;

    public GuildDeleteHandler(java.util.function.Supplier<Integer> remainingServers) {
    ...
    public void onGuildLeave(GuildLeaveEvent event) {
        try {
            ...
            LeaveGuildWebhook.sendLeaveGuildWebhook(
                    guild.getId(),
                    guild.getName(),
                    guild.getMemberCount(),
                    remainingServers.get()
            );
        } catch (Exception e) {
