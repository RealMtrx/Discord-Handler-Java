...
public class WebhookSender {
    ...
    public static class Embed {
        public String title, description, timestamp;
        public int color;
    ...
    public static String makeTimestamp() { return Instant.now().toString(); }
    public static String footerText(String botName, String suffix) { return botName + " \u2022 " + suffix; }
}
